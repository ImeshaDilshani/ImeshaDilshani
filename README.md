...
### A Developer focused on Data Science | AI/ML-Powered Software Engineering | Mobile Development
...
| Area | Technologies | Focus |
| :--- | :--- | :--- |
| **Software Development** | JavaScript (Node.js), Python (Django), Java, C# | Develop scalable backend services and APIs for high-performance applications. |
| **Mobile Development** | Flutter / Dart, React Native, Firebase, Supabase, UI/UX Principles | Create cross-platform or native mobile apps focused on performance and user experience. |
